...
const Index = () => {
  ...
  const testQuestions = [
    ...
    {
      question: 'Что такое действующее значение переменной величины (тока, напряжения)?',
      answers: [
    ...
    {
      question: 'Каково соотношение между средним Iср и амплитудным Im значением синусоидального тока?',
      answers: [
        'Iср = Im',
        'Iср = Im/√2',
        'Iср = 2Im/π',
    ...
    {
      question: 'Что такое угловая частота ω переменного тока?',
      answers: [
    ...
    {
      question: 'Какой элемент электрической цепи обозначен на рисунке?',
      answers: [
        'Резистор',
        'Конденсатор',
    ...
    {
      question: 'Как зависит ёмкостное сопротивление Xc от частоты f переменного тока?',
      answers: [
    ...
    {
      question: 'Как записывается закон Ома для ёмкостного сопротивления Xc?',
      answers: [
        'I = U·R',
        'I = U/R',
        'I = R/U',
    ...
    {
      question: 'Каков угол сдвига фаз между током и напряжением на индуктивном сопротивлении?',
      answers: [
        'φ = 0° (совпадают по фазе)',
        'φ = 90° (напряжение опережаетток)',
    ...
    {
      question: 'Для какого элемента построена векторная диаграмма на рисунке?',
      answers: [
        'Катушка индуктивности',
        'Конденсатор',
        'Резистор',
    ...
    {
      question: 'Какая мощность выделяется на ёмкостном сопротивлении в цепи переменного тока и в чему она равна?',
      answers: [
    ...
    {
      question: 'В каких единицах измеряется активная мощность P?',
      answers: [
        'Вольт-амперы (ВА)',
    ...
    {
      question: 'Что такое амплитудное значение переменной величины (тока, напряжения)?',
      answers: [
    ...
    {
      question: 'Что такое частота T переменного тока?',
      answers: [
        'Время, за которое ток достигает амплитудного значения',
        'Время одного полного колебания, измеряется в секундах (Гц)',
    ...
    {
      question: 'Как зависит индуктивное сопротивление XL от частоты f переменного тока?',
      answers: [
    ...
    {
      question: 'Как записывается закон Ома для индуктивного сопротивления XL?',
      answers: [
        'I = U·XL',
        'I = U/XL',
        'I = U + XL',
    ...
    {
      question: 'Каков угол сдвига фаз между током и напряжением на ёмкостном сопротивлении?',
      answers: [
        'φ = 0° (совпадают по фазе)',
    ...
    {
      question: 'Каков угол сдвига фаз между током и напряжением на активном сопротивлении?',
      answers: [
        'φ = 0° (совпадают по фазе)',
        'φ = 90° (напряжение опережает ток)',
        'φ = -90° (ток опережает напряжение)',
    ...
    {
      question: 'Какая мощность выделяется на индуктивном сопротивлении?',
      answers: [
        'Активная мощность P > 0',
        'Реактивная мощность Q > 0, активная мощность P = 0',
    ...
    {
      question: 'В каких единицах измеряется реактивная мощность Q?',
      answers: [
        'Вольт-амперы (ВА)',
        'Вольт-амперы реактивные (вар)',
        'Ватты (Вт)',
    ...
    {
      question: 'Что такое мгновенное значение переменной величины (тока, напряжения)?',
      answers: [
        'Среднее значение за период',
    ...
    {
      question: 'Каково соотношение между действующим I и средним Iср значением синусоидального тока?',
      answers: [
        'I = Iср',
        'I = Iср/√2',
        'I = √2·Iср',
    ...
    {
      question: 'Как зависит активное сопротивление R от частоты f переменного тока?',
      answers: [
    ...
    {
      question: 'Какая мощность выделяется на активном сопротивлении R?',
      answers: [
